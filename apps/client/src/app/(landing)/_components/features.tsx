      ...
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <p className="mt-4">
            ...
            quisquam sunt rem ex, eius animi aperiam dicta nihil illo est.
          </p>
        </div>
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 [--color-background:var(--color-muted)] [--color-card:var(--color-muted)] *:text-center md:mt-16 dark:[--color-muted:var(--color-zinc-900)]">
          <Card className="bg-background group border-0 shadow-none">
            <CardHeader className="pb-3">
              <CardDecorator>
                <Zap className="size-6" aria-hidden />
              </CardDecorator>

              <h3 className="text-sm font-semibold">Customizable</h3>
            </CardHeader>
          ...
          <Card className="bg-background group border-0 shadow-none">
            <CardHeader className="pb-3">
              ...
              <h3 className="text-sm font-semibold">You have full control</h3>
            </CardHeader>
          ...
          <Card className="bg-background group border-0 shadow-none">
            <CardHeader className="pb-3">
              ...
              <h3 className="text-sm font-semibold">Powered By AI</h3>
            </CardHeader>
