  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className="cursor-pointer hover:bg-foreground/4 rounded-md p-2 flex gap-2 items-center mb-2">
          ...
          <h5 className="flex-1 trucate text-sm">{selectedWorkspace.name}</h5>
          <ChevronDown size={14} />
        </div>
      </DropdownMenuTrigger>
